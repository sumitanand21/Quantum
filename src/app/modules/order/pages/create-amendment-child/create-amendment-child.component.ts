...
@Component({
  selector: 'app-create-amendment-child',
  templateUrl: './create-amendment-child.component.html',
  styleUrls: ['./create-amendment-child.component.scss']
})
export class CreateAmendmentChildComponent implements OnInit {
  Competitortab = true;
  ...
  {
    debugger;
   const dialogRef = this.dialog.open(CreateAmendmentPopupComponent, {
     width: '500px',
  });   
