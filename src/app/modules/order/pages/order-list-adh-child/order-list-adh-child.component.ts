...
@Component({
  selector: 'app-order-list-adh-child',
  templateUrl: './order-list-adh-child.component.html',
  styleUrls: ['./order-list-adh-child.component.scss']
})
export class OrderListAdhChildComponent implements OnInit {
  Competitortab = true;
